            ...
            <section className="booking-space p-0">
                <div className="container-fluid">
                    <div className="row border-top border-bottom">
                        ...
                        <div className={`col-xl-9 col-md-9 col-sm-12 px-3 
                            d-flex
                            flex-xl-row 
                            flex-column
                            align-items-center justify-content-${isFilterOpen ? 'between' : 'end'}`}>
                            ...
                            <div className="col-xl-5 col-12 btn-spaces-filter text-center">
                                <Button 
                                    ...
                                    className="button-outLine px-4 btn-bg-black btn-filter text-center"
                                    style={{
                                        width: '180px'
                                    }}
                                >
