                ...
                <div className="container-fluid px-70">
                    ...
                    <div className="row align-items-center">
                        <div className="col-xxl-3 col-xl-4 col-md-6 col-12">
                            <img src={img} alt='' width= '307px' height= '324px'/>
                        </div>
                        <div className='col-xxl-9 col-xl-8 col-md-6 col-12'>
                            <div className='d-flex align-items-center  mb-3'>
                                <h1 className="course_details_title mb-0">Anudeep Ayyagari</h1>
                                <img src={confirmedIcon} alt='confirmed Icon'/>
                            </div>
                            <Paragraph className='course_details_light_desc opacity-100'>29-year UX + Design Veteran; Consultant, Author & Speaker</Paragraph>
                            <div className='d-flex align-items-center  mb-4'>
                                <div className='d-flex align-items-center'>
                                    <img src={star} alt='star icon'/>
                                    <span className='rate ms-2 fw-semibold'>4.5</span> 
                                    <span className='reviews'>Instructor Rating</span>
                                </div>
                                <div className='d-flex align-items-center ms-3'>
                                    <img src={videoIcon} alt='confirmed Icon'/>
                                    <span className='reviews ms-2 fw-semibold'>8</span>
