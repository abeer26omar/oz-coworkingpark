...
const Header = ({showBlackNav}) => {
    ...
    const [Widow , SetWindow] = useState(false);
                          ...
                          <ul class="dropdown-menu dropdown-nav-user " aria-labelledby="dropdownMenuLink">
                             <div className="close-drop border-dropdown p-3">
                                <Button 
                                    ...
                                    <li onClick={handleLink} className="drop_event border-dropdown" id="explore">Explore
                                       <img className={ explore ?"px-2 up_down" : "px-2 up_down up"} src={Up} alt="Up"/>
                                       <ul className={ explore ? "dropdown-explore":"dropdown-explore show-ex"}>
                                        <li>Membership</li>
                                        <li>Spaces</li>                                        
                                        </ul>
                                    </li>
                                     <li className="drop_event border-dropdown">About OZ</li>
                                      <li className="drop_event border-dropdown">Talent Market </li>
                                       <li className="drop_event border-dropdown">Get Direction </li> 
                                    <li className="drop_event border-dropdown">Contact Admin</li> 
                                    <li className="drop_event border-dropdown">Rewards</li>
                                     <li className="drop_event border-dropdown">Al-sheikh Zayed
                                    <img className={ explore ?"px-2 up_down" : "px-2 up_down up"} src={Up} alt="Up"/>
                                    </li>
