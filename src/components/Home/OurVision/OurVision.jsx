                ...
                <div className="container-fluid">
                    ...
                    <div className="row border-of-section ">
                        ...
                        <div className="col-md-8 col-lg-8 col-sm-8 col-xs-6 border-left">
                            <img className="image-box w-100" src={vision} alt="Our OZ Vision" lazyLoad/>
                        </div>
                        </div>
                </div>
            </section>
                ...
                <div className="container-fluid">
                    ...
                    <div className="row border-of-section ">
                        <div className="col-md-8 col-lg-8 col-sm-8 col-xs-6 border-right ">
                            <img className="image-box w-100" src={aminites} alt="Our OZ Vision" lazyLoad/>
                        </div>
                            ...
                            <div className="box-content px-60">
                                ...
                                <div className="d-flex justify-content-start align-items-center mb-5">
                                    <div className="amenities-box">
                                        <img src={alarm} alt="alarm amenities-icon" className="amenties-icon"/>
                                        <h5 className="amenities-text">24 hours</h5>
                                    </div>
                                    <div className="amenities-box">
                                        <img src={hand} alt="alarm amenities-icon" className="amenties-icon"/>
                                        <h5 className="amenities-text">Perks</h5>
                                    </div>
                                    <div className="amenities-box">
                                        <img src={gym} alt="alarm amenities-icon" className="amenties-icon"/>
                                        <h5 className="amenities-text">Fitness</h5>
                                    </div>
                                    <div className="amenities-box">
                                        <img src={user} alt="alarm amenities-icon" className="amenties-icon"/>
            ...
            <section className=" ">
                <div className="container-fluid">
                    ...
                    <div className="row border-of-section ">
                        ...
                        <div className="col-md-4 col-lg-4 col-sm-4 col-xs-6 m-auto ">
                            <div className="box-content px-60">
                                <h2 className="h2-text-box">FRESH RECIPES
                                ...
                                <a href="#" className="btn button-outLine btn-bg-white">Explore F&B</a>
                            </div>
                        </div>
                    </div>
                </div>
