...
const CaseOne = ({bookingData, servicesPrice, price, getPromoValue, getPromoId}) => {
    ...
    const removeService = (index) => {
      ...
      servicesPrice(updatedServices.reduce((sum, item) => sum + item.price, 0))
    };
    ...
    return (
        <>
                    ...
                    <div className="col-lg-6 col-12">
                        <ul className="list-details px-sm-3 px-1">
                            ...
                            <li className='mb-3'>
                                ...
                                <span className={`ms-3 ${priceAfterPromo !== '' ? 'promoApplided' : ''}`}>{price === '0' ? 'Free' : price + ' EGP'}</span>
                            </li>
                            ...
                            <li className="d-flex flex-column mb-0">
                                <PromoCode 
                                    price={price} 
                                    getPrice={getPrice} 
                            ...
                            <li className="price-promo d-flex justify-content-between align-items-center">
                                  <p>Total Price:</p>
                                  <p>{priceAfterPromo || price}</p>
                            </li>
                        </ul>
                    </div>
                </div>
            </div>
            <div className="terms align-self-start">
                <Button 
                    tagType='link'
            ...
            <div className="step-one">
                {/* <a className="btn button-outLine btn-bg-white" onClick={handleBookingClick}>Booking</a> */}
            </div>
