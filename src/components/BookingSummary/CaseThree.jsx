      ...
      <div className="row" >
        <div className="col-lg-6 col-md-6 col-sm-12 order-summary">
            ...
            <div className="d-flex align-items-center justify-content-between">
              ...
              {/* <span className="location w-40" 
                dangerouslySetInnerHTML={{
                  __html: DOMPurify.sanitize(bookingResult.invoice_address.replace(/\n/g, "<br />")),
                }}>
              </span> */}
            </div>
          </div>
          <div className="order-description">
            ...
            <div className="d-flex align-items-center justify-content-between line">
              <span className="date-period">Tax {''}%</span>
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 order-summary-black ">
          <div className="order-details">
            ...
            <div className="booking-items">
              <span>Date: </span>
             {/* {moment(bookingResult.course?.start_date, 'HH:mm:ss').format("dddd, MMM. D, YYYY")}  */}
