                                ...
                                <div className='card card_event p-3 mb-3' 
                                    ...
                                    <div className='row g-3 align-items-center'>
                                        <div className='col-lg-3 col-12 d-flex align-items-center justify-content-center'>
                                            {activeTab === 'market' ? <img src={item?.user_id.avatar} alt='event-img'  width={'134px'} height={'136px'} style={{
                                                objectFit:'fill',
                                                borderRadius: '50%'
                                            ...
                                            <div className='col-lg-9 col-12'>
                                                <div className='d-flex justify-content-between align-items-center'>
                                                    ...
                                                    {activeTab === 'booking' && <ul className="list-options d-flex p-0 py-3 m-0">
                                                    ...
                                                    {activeTab === 'event' &&  <ul className="list-options d-flex p-0 py-4 m-0" style={{
                                                        listStyle: 'none'
                                                    }}>
                                                    ...
                                                    {activeTab === 'booking' && (
                                                        <div className='d-flex justify-content-between align-items-center'>
                                                            ...
                                                            <Button 
                                                                tagType='link' 
                                                                className="btn_outline_black" style={{
                                                                    padding: '.6rem 3rem'
                                                                }}>book now</Button>
                                                        </div>
                                                    )}
