...
const PromoCode = ({price, getPrice, getPromoId, getPromoValue}) => {
    ...
    return(
        <>
            ...
            {error !== '' ? 
                (<div class="fs-16 text-danger d-flex align-items-center align-self-start" role="alert">
                    {error}
                </div>) 
                : null}
            {success !== '' ? 
                (<div class="fs-16 text-success d-flex align-items-center align-self-start" role="alert">
                    Applied
                </div>) 
                : null}
        </>
